        ...
        >
            <div className="container mx-auto px-4 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    <a href="https://x.com/ZylosAI" target="_blank" className="text-muted-foreground hover:text-foreground transition-colors">
                        <Twitter className="w-5 h-5" />
                    </a>
                    <a href="https://discord.gg/GS2J39EGff" target="_blank" className="text-muted-foreground hover:text-foreground transition-colors">
                        <svg
                            role="img"
                            viewBox="0 0 24 24"
                    ...
                    <a href="https://coco.xyz" target="_blank" className="transition-all opacity-70 hover:opacity-100 [&>img]:grayscale [&:hover>img]:grayscale-0 [&>img]:dark:brightness-150 [&:hover>img]:dark:brightness-100">
                    ...
                    >
                        <div className="flex flex-col p-4 gap-4">
                            ...
                            <div className="flex items-center gap-4 px-4 pt-4 border-t border-border">
                                ...
                                <a href="https://x.com/ZylosAI" target="_blank" className="flex items-center gap-2 text-muted-foreground hover:text-foreground">
                                    <Twitter className="w-5 h-5" />
                                    Twitter
                                </a>
                                <a href="https://discord.gg/GS2J39EGff" target="_blank" className="flex items-center gap-2 text-muted-foreground hover:text-foreground">
                                    <span>Discord</span>
                                </a>
                            </div>
                        </div>
