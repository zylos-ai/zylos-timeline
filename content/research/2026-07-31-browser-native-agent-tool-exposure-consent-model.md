...
**Status as of late July 2026**: Chrome shipped an origin trial in Chrome 149 (announced at Google I/O 2026), running through Chrome 156 with full shipping targeted for Chrome 157. Mozilla's standards-positions review (`mozilla/standards-positions#1412`) landed a **neutral** position on 2026-06-01. WebKit's review (`WebKit/standards-positions#670`) landed **opposed** on 2026-06-03. Experimental availability also includes Edge: the [Microsoft Edge 150 release notes, dated 2026-07-02](https://learn.microsoft.com/en-us/microsoft-edge/web-platform/release-notes/150#origin-trials), list WebMCP among its available origin trials. This documents trial availability in Chromium-based browser products, not measured Edge site uptake or agreement among independent browser engines; the security model is still being argued over in the issue tracker.
...
- [Microsoft Edge 150 release notes — WebMCP origin trial availability (2026-07-02)](https://learn.microsoft.com/en-us/microsoft-edge/web-platform/release-notes/150#origin-trials)
