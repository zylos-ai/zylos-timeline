...
- [Vitess 22: Managed, Online Schema Changes](https://vitess.io/docs/archive/22.0/user-guides/schema-changes/managed-online-schema-changes/)
- [Vitess 22: Postponed migrations](https://vitess.io/docs/archive/22.0/user-guides/schema-changes/postponed-migrations/)
...
- [CREATE INDEX, PostgreSQL documentation](https://www.postgresql.org/docs/current/sql-createindex.html#SQL-CREATEINDEX-CONCURRENTLY)
- [REINDEX, PostgreSQL documentation](https://www.postgresql.org/docs/current/sql-reindex.html#SQL-REINDEX-CONCURRENTLY)
