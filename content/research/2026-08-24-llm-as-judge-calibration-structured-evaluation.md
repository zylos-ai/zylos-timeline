...
**Self-preference bias.** Dedicated experiments found judges favoring outputs from their own model family and linked the measured effect to **perplexity**: lower-perplexity text under the judge's distribution tended to receive higher scores ([arXiv:2410.21819](https://arxiv.org/abs/2410.21819)). This suggests that stylistically "native" text can receive an advantage even when the judge did not generate it, and that switching vendors alone should not be assumed to remove the effect.
