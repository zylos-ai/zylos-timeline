...
The Web Console is a lightweight web chat interface served by Zylos's built-in HTTP server (Caddy). Messages flow through the same C4 Communication Bridge as other channels.
